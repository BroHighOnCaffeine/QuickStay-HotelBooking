    ...
    <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30">
      <div className="flex flex-col md:flex-row items-center justify-between w-full">
        <Title
          ...
          subTitle="Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloremque praesentium ullam vel laudantium fugiat nihil perferendis facilis error tempora."
        />
        ...
        {exclusiveOffers.map((item) => (
          <div
            ...
            style={{ backgroundImage: `url(${item.image})` }}>
                ...
                {/* // Why are we using Backticks `` for providing url() in backgroundImage . Similarly, What's the use of ${} together. [👆🏻] */}


            <p className="px-3 py-1 absolute top-4 left-4 text-xs bg-white text-gray-800 font-medium rounded-fulll">
              {item.priceOff}%off
            </p>
            <div>
            ...
            <button className="flex items-center gap-20 font-medium cursor-pointer mt-4 mb-5">
                View Offers
