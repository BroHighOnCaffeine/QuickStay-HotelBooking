  ...
  return (
    <div className='flex flex-col item-start justify-center px-6 md:px16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
      <p className="bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20 1 w-fit">The Ultimate Hotel Experience</p>
         ...
         {/*  Title */}
    <h1 className="font-playfair text-2x1 md:text-5x1 md:text-[56px] md:leading-
[56px] font-bold md:font-extrabold max-w-xl mt-4 ">Discover Your Perfect Gateway Destination</h1>

    <p className="max-w-130 mt-2 text-sm md:text-base">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Consequuntur rerum neque praesentium incidunt molestias quasi maiores voluptates! Tempora!</p>
