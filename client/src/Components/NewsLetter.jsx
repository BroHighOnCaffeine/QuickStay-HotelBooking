...
// Adding NewsLetter Subscription Part 
...
const NewsLetter = () => {
  return (
    <div className="flex flex-col items-center max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
        ...
        <Title title="Stay Inspired" subTitle="Lorem ipsum dolor, sit amet consectetur adipisicing elit. Modi sapiente deleniti autem magnam laborum laboriosam praesentium sed obcaecati eveniet quas!" />
