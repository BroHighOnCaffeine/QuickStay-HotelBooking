...
const Dashboard = () => {
  ...
  // fetchDashboardData function Calling whenever the Page gets loaded
  useEffect( () => {
  ...
  return (
    <div>
      <Title align='left' font='outfit' title='Dashboard' subTitle="Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis accusamus adipisci sunt, mollitia molestias eius voluptatibus dolorem cumque aliquid modi? Quaerat porro delectus enim reprehenderit, nobis asperiores cumque vero ex? " />
      ...
      {/* Now we'll display a Table but keep it inside div  */}
              ...
              <tbody className='text-sm'>
                {dashboardData.bookings.map((item,index)=>(
                  <tr key={index}>
                    ...
                    <td className='py-3 px-4 text-gray-700 max-sm:hidden border-t border-gray-300 text-center'>
